...
export const metadata: Metadata = {
  ...
  keywords: [
    "Hayden Zeller", "Home", "Hayden Zeller Home", "Hayden Zeller Projects", 
    "Hayden Zeller News", "Hayden Zeller Updates", "Hayden Zeller Blog", 
    "Hayden Zeller Blog Posts", "Hayden Zeller Blog Updates", 
    "Hayden Zeller Blog News", "Hayden Zeller Blog Projects", 
    "Hayden Zeller Blog Posts Projects News Updates", 
    "Hayden Zeller Blog Posts Projects News Updates Home"
  ],
  alternates: { canonical: "https://haydenzeller.com" },
  twitter: { card: "summary", site: "@haydenzeller" },
  openGraph: {
    type: "website",
...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center w-screen min-h-screen overflow-hidden bg-gradient-to-tl from-black to-transparent">
      ...
      <Particles className="absolute inset-0 -z-10 bg-black min-h-screen overflow-hidden" quantity={400} />
